...
#region Unity API
    private void Awake()
    {
        ...
        // Debug.Log( $"[FF] Screen({screen}) - Ratio:{screenRatio} - GameSetting.Ratio:{GameSettings.Instance.game_reference_screenRatio} - New Scale:{transform.localScale}", transform );
	}
#endregion
